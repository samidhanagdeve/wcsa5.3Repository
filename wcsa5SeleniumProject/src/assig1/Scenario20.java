...
public class Scenario20 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement target = driver.findElement(By.xpath("//span[text()='10 Gram']"));
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//img[@class='hc img-responsive center-block lazyloaded']/ancestor::a[@id='pid_9167']")).click();
