...
//    wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='chat-icon']"))).click();
	...
	Thread.sleep(2000);
	driver.findElement(By.id("chat-fc-name")).sendKeys("Samidha");
	driver.findElement(By.id("chat-fc-email")).sendKeys("samidha@123");
	driver.findElement(By.id("chat-fc-phone")).sendKeys("9999988888");
